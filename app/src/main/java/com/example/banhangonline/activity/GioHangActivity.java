...
import com.example.banhangonline.adapter.GioHangAdapter;
...
public class GioHangActivity extends AppCompatActivity {
    ...
    private void tinhTongTien() {
        ...
        for(int i = 0; i<Utils.manggiohang.size(); i++){
            ...
            tongtiensp += gioHang.getSoluong() * gioHang.getGiasp(); // Nhân số lượng với giá của sản phẩm
        }
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        tongtien.setText(decimalFormat.format(tongtiensp)); // Định dạng tổng tiền
    }
